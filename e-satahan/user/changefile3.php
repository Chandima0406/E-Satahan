...
$file3=md5($file).time().$extension1;
  move_uploaded_file($_FILES["file3"]["tmp_name"],"folder3/".$file3);
$sql="update tblnotes set file3=:file3 where ID=:eid";
...
<html lang="en">
<head>
    <title>e-satahan || Update Notes File</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update Note File Third</h6>
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">View Old file3</label>
                                   <a href="folder3/<?php echo $row->file3;?>" width="100" height="100" target="_blank"> <strong style="color: red">View Old File</strong></a>
                                ...
                                <div class="mb-3">
                                   ...
                                   <input type="file" class="form-control"  name="file3" value="" required='true'>
