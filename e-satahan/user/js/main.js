(function ($) {
    ...
    if ($('#progressBar').length) {
        ...
        var interval = setInterval(function() {
            ...
            ctx.fillRect(0, 0, progressBar.width * (progress / 100), progressBar.height);
        }, 50);
    }
        ...
        var myChart3 = new Chart(ctx3, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: "1",
                    backgroundColor: "rgba(0, 156, 255, .5)",
                    pointHighlightStroke: "rgba(26, 179, 148, .5)",
                    data: [100, 120, 290, 230, 400, 350, 460, 420, 500, 480, 520]
                }]
            },
            options: {
                responsive: true,
